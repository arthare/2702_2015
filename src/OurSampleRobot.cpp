 ...
 * autonomous state.
 */
void OurSampleRobot::Autonomous()
{
	printf("Default %s() method... Override me!\n", __FUNCTION__);
}
 ...
 */
void OurSampleRobot::OperatorControl()
{
	printf("Default %s() method... Override me!\n", __FUNCTION__);
}
 ...
 */
void OurSampleRobot::StartCompetition()
{
